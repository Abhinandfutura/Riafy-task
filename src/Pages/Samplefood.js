    ...
    const [state,setState]=useState(
{
  ...
  useEffect(() => {
    if(searchValue === ""){
      ...
      const newcards = cards.filter(value => value.Ingredient.toLowerCase().includes(searchValue.toLowerCase()))
...
<SearchDiv>
<SearchIcn />
<SearchInput onChange={(e)=> setSearchValue(e.target.value)} placeholder="Food name"></SearchInput>
</SearchDiv>
</FoodSearch>
...
<ItemName>{i.Ingredient}</ItemName>
<ShorTxt>
{i['Short text']}
</ShorTxt>
</Card>
